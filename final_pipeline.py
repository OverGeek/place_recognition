...
img_dir = 'E:\Sem 6 Project\Lhilo Sir\Hypotheses\images\\1100\\rgb\image_0'
processed_img_dir = './new_dataset/alphabets'
preds = {}
...
for i in tqdm(range(len(os.listdir(img_dir)))):
    ...
    object_boxes = make_predictions_alphabet(input_image_path)
    # K.clear_session()
...
with open('./preds_alphabet.json', 'w') as f:
    json.dump(preds, f)
